<?php
	...
	define( "DB_DSN", "mysql:host=localhost;dbname=hotel" );
	define( "DB_USER", "root" );
	define( "DB_PASS", ""  );
	define( "CORE", "core/" );
	define( "PAGES", "pages/" );
	...
	define( "SITENAME", "Online Hotel Reservation System"  );
	...
	if (!as_check_db_value('adminid', 'level', 5, 'admins'))  {
		$as_err = array();
		$as_err['errno'] = 2;
		$as_err['errtitle'] = 'Create Your Own Account First';
		$as_err['errsumm'] = 'There are no admins yet! That means you need to set up your own account to proceed';
		require_once CORE .  'error.php';
		exit(); 
	}