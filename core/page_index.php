<?php 
	...
	function as_navigation($request, $html = '')
	{
		...
		if ( $adminid ) {			
			...
			$navigation['clients'] = array('label' => 'Clients', 'url' => 'index.php?open=client_all');
			$navigation['rooms'] = array('label' => 'Rooms', 'url' => 'index.php?open=room_all');
			$navigation['admins'] = array('label' => 'Admins', 'url' => 'index.php?open=admin_all');
